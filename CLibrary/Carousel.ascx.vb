...
Partial Class CLibrary_Carousel
    ...
    Private _NumberOfItemsToShow As Integer = 3
    <appx.cms(appx.cmsAttribute.DataValueType.Free)> _
    ...
    Private _WrapStyle As CarouselWrapStyle = CarouselWrapStyle.None
    Public Property WrapStyle() As CarouselWrapStyle
        Get
            Return _WrapStyle
        End Get
        Set(ByVal value As CarouselWrapStyle)
            _WrapStyle = value
        End Set
    End Property
    ...
    Protected Overrides Sub BuildControl()
        If Not String.IsNullOrEmpty(Me.SourceDirectory) Then
            ...
            If oCarousel IsNot Nothing Then
                ...
                jqueryHelper.IncludePlugin(Page, "jCarousel" & Me.ClientID, "~/scripts/Carousel.ashx?carouselid=" & Server.UrlEncode(Me.CarouselId) & "&auto=" & Me.AutoScrollInterval & "&visible=" & Me.NumberOfItemsToShow & "&wrap=" & Me.WrapStyle.ToString)
                jqueryHelper.RegisterStylesheet(Page, "~/scripts/jquery.jcarousel.css")
                If String.IsNullOrEmpty(sStylesheet) Then
                    sStylesheet = "~/scripts/Carousel.css.ashx?class=" & Server.UrlEncode(Me.CssClass) & "&w=" & oCarousel.Width & "&h=" & oCarousel.Height & "&num=" & Me.NumberOfItemsToShow
                End If
