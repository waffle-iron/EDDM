        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="/Step1-Target.aspx"  target="_self" title="Target">Target</a></li>
            ...
            <div class="col-sm-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="/Support" title="Support"><span class="fa fa-support"></span>&nbsp;Support</a></li>
                    <li><a target="_self" href="#"><uc1:BoldChatTextLink runat="server" id="BoldChatTextLink" /></a></li>
                </ul>
            ...
            <div class="col-sm-4">
                <h3>Payment Options</h3>
                        ...
                        <div class="visible-xs">
                            <p>
                            <span class="fa fa-cc-mastercard fa-1x"></span>
                            <span class="fa fa-cc-visa fa-1x"></span>
                            <span class="fa fa-cc-discover fa-1x"></span>
                            <span class="fa fa-cc-amex fa-1x"></span>
                            </p>
                        </div>
                    
                <p>
                    <img id="footerlogo" alt="" src="/assets/images/footer-logo.png" class="img-responsive" />
                </p>
                <address>
                    <small>
