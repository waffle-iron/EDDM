<%@ Page Title="" Language="VB" MasterPageFile="~/App_MasterPages/Site.master" AutoEventWireup="false" CodeFile="Step1-UploadYourList.aspx.vb" Inherits="UploadYourList" %>
                        ...
                        <div class="well well-sm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-left">
                                    <a id="btnStep1" class="btn btn-danger btn-lg">
                                ...
                                <div class="col-sm-6 text-right">
                                    <a id="btnStep3" class="btn btn-danger btn-lg">
...
<asp:Content ID="Content7" ContentPlaceHolderID="cpScripts" runat="Server">
    ...
    <script type="text/javascript" src="../assets/javascripts/Step1-UploadYourList.js"></script>
