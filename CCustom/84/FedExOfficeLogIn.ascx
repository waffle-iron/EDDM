<%@ control language="VB" autoeventwireup="false" codefile="FedExOfficeLogIn.ascx.vb" inherits="FedExLogIn" %>
    ...
    <div id="userMenu">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4 col-sm-offset-2 text-center" id="logonMessage">
