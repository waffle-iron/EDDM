<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPages/Site.master" AutoEventWireup="true" CodeFile="TargetDataMap3.aspx.cs" Inherits="TargetDataMap3" Trace="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpScripts" Runat="Server">
    ...
    <script src="../assets/javascripts/TargetDataMap3.min.js"></script>
