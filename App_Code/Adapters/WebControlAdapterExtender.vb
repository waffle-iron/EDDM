...
Namespace CSSFriendly
    Public Class WebControlAdapterExtender
        ...
        Public Sub WriteTopLabel(ByVal writer As HtmlTextWriter, ByVal className As String, ByVal text As String, ByVal forId As String)
            If (Not String.IsNullOrEmpty(text)) Then
                writer.WriteLine()
        ...
        '  Can't be static because it uses MakeChildId
        Public Sub WriteTextBoxTopLabel(ByVal writer As HtmlTextWriter, ByVal isPassword As Boolean, ByVal labelClassName As String, ByVal labelText As String, ByVal inputClassName As String, ByVal id As String, ByVal value As String)
            WriteTopLabel(writer, labelClassName, labelText, id)
        ...
        Public Sub WriteSubmit(ByVal writer As HtmlTextWriter, ByVal buttonType As ButtonType, ByVal className As String, ByVal id As String, ByVal imageUrl As String, ByVal javascript As String, ByVal text As String)
            ...
            Select Case buttonType
                ...
                Case buttonType.Image
                    ...
                    writer.WriteAttribute("src", VirtualPathUtility.ToAbsolute(imageUrl))
                    idWithType += "ImageButton"
                    Exit Select
                Case buttonType.Link
                    writer.WriteBeginTag("a")
