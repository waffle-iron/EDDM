<%@ Page Title="" Language="VB" MasterPageFile="~/App_MasterPages/QuoteRequest.master" AutoEventWireup="false" CodeFile="EDDMQuote.aspx.vb" Inherits="EDDMQuote" %>
...
<%@ Register Src="~/CCustom/1/FacebookTrackingPixel.ascx" TagPrefix="appx" TagName="FacebookTrackingPixel" %>
<%@ Register Src="~/CLibrary/VisualWebsiteOptimizer.ascx" TagPrefix="appx" TagName="VisualWebsiteOptimizer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="phHeaderLg" Runat="Server">
    <asp:Literal ID="litLgHeader" runat="server" />
</asp:Content>


<asp:Content ID="Content3" ContentPlaceHolderID="phHeaderSm" Runat="Server">
    <asp:Literal ID="litSmHeader" runat="server" />
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="phBody" runat="Server">
    ...
    <asp:Panel ID="pnlSuccess" runat="server" Visible="False">
        ...
        <asp:PlaceHolder ID="phProductInfo" runat="server">
            <div class="row">
                <div class="col-sm-9">
    ...
    <appx:FacebookTrackingPixel runat="server" id="FacebookTrackingPixel" />
    <appx:VisualWebsiteOptimizer runat="server" id="VisualWebsiteOptimizer" />
