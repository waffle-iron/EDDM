<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPages/Site.master" AutoEventWireup="true" CodeFile="TargetDataMap1.aspx.cs" Inherits="TargetDataMap1" Trace="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cpScripts" Runat="Server">
    ...
    <script src="../assets/javascripts/TargetDataMap1.min.js"></script>
