...
Namespace appx.CustomWebParts
    Public Class WebPartsChrome
        ...
        Protected Shadows ReadOnly Property Zone() As appX.CustomWebParts.WebPartsZone
            Get
                Return MyBase.Zone
            End Get
        End Property
        ...
        Private Sub RenderButton(ByVal writer As System.Web.UI.HtmlTextWriter, ByVal clientID As String, ByVal buttonName As String, ByVal webPart As WebPart, Optional ByVal MethodName As String = "", Optional ByVal Display As String = "block")
            ...
            img.Src = String.Format("/wp/{0}.png", buttonName)
            img.Attributes.Add("onmouseover", String.Format("this.src='/wp/{0}.png';", buttonName))
            img.Attributes.Add("onmouseout", String.Format("this.src='/wp/{0}.png';", buttonName))
        ...
        Private Sub RenderTitleBar(ByVal writer As System.Web.UI.HtmlTextWriter, ByVal webPart As System.Web.UI.WebControls.WebParts.WebPart)
            ...
            webPart.Page.ClientScript.RegisterStartupScript(Me.GetType(), clientID, scriptBuilder.ToString(), True)
        End Sub
