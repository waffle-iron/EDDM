<%@ Control Language="C#" AutoEventWireup="true" CodeFile="StaplesCarousel.ascx.cs" Inherits="StaplesCarousel" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-10 col-sm-offset-1">
                                    ...
                                    <div id="ctaContent">
                                        ...
                                        <h1>Introducing direct mail from Staples&reg;</h1>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 text-center">
                                                <asp:Hyperlink ID="hypEDDM" runat="server" NavigateUrl="~/EDDM-Overview" CssClass="btn btn-info btn-lg lrgActionButton">
                                    ...
                                    <div id="ctaContent2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5 col-md-offset-1 text-center">
                                                <asp:Hyperlink ID="hypQuote" runat="server" NavigateUrl="~/EDDM-Quote-Request" CssClass="btn btn-primary btn-block btn-lg lrgActionButton">
