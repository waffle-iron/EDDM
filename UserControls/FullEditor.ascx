<%@ Control Language="VB" AutoEventWireup="false" CodeFile="FullEditor.ascx.vb" Inherits="usercontrols_FullEditor" %>
...
<asp:UpdatePanel ID="pEd" runat="server">
    <ContentTemplate>
        <%--PopupHolderID="popupHolder"--%>
        <obouted:Editor ID="oEd" runat="server" Height="400">
            <TopToolbar ID="Top" Appearance="Custom" runat="server">
                <AddButtons>
                    ...
                    <obouted:ForeColorGroup runat="server" />
