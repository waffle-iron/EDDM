...
Partial Class EDDMQuote
    ...
    Protected Sub Page_Init(sender As Object, e As System.EventArgs) Handles Me.Init
        ...
        If SurveyResponseId > 0 Then
            ...
            Response.Write("<!-- Survey Data Begin" & ControlChars.CrLf)
            ...
            If Not String.IsNullOrEmpty(sProduct) Then
                ...
                If oProd IsNot Nothing Then
                    ...
                    'Make a new SortedList just for Ramp Express
                    Dim rampList As New SortedList(Of Integer, Integer)

                    'Hack. Booo. Hiss. 
                    If siteID = 98 Then

                        For Each priceBreak In aQty

                            Dim i As Integer = priceBreak.Key
                        ...
                        If iQty > 0 Then
                            If Not rampList.ContainsKey(iQty) Then
                                rampList.Add(iQty, iQty)
                            End If
                        End If

                        'Test it out
                        'For Each item In rampList
                        '    Response.Write("<h2>" & item.Key.ToString() & "</h2>")
                        'Next
                    ...
                    'Additional customization.  Will improve later.
                    'RAMP Express
                    If siteID = 98 Then
                        litLgHeader.Text = "Here is your <u>free</u> Instant Direct Mail Quote!"
                        litSmHeader.Text = "Here is your <u>free</u> Instant Direct Mail Quote!"
                        phProductInfo.Visible = False
                    Else
                        litLgHeader.Text = "Here is your <u>free</u> Instant Every Door Direct Mail&reg; Quote!"
                        litSmHeader.Text = "Here is your <u>free</u> Instant Every Door Direct Mail&reg; Quote!"
                    End If
                ...
                Else
                    ...
                    EmailUtility.SendAdminEmail("EDDMQuote.aspx could not find the product. (oProd was null). SiteID is <strong>" & siteID & "</strong>. Attempt for Quote was made by " & sEmail & ".")
